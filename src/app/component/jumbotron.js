        ...
        <section className="bg-linear-to-r from-[#373A40] to-[#DC5F00] flex flex-col min-h-screen justify-center md:flex-row " id="home">
            ...
            <div className="md:px-1 mx-auto w-full p-2 md:w-5/10 text-center lg:py-40">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-[#DC5F00] hover:bg-white hover:text-black focus:ring-4 focus:ring-[#DC5F00] dark:focus:ring-[#DC5F00]">
                        Download CV
                    </a>
            ...
            <div className="bg-center bg-no-repeat bg-[url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhYXMIFiOH-Yy92bWDr2R6D8xe04ZSkr_2NPSFQmRaILVKRg4oh9ihi9ByocvmJMjf2x1HiZABmhmHFwnuxunKCjj9IlYdWZhmxk5q8GQT3MKzpwcM3_iJX_fPtrWyY6-YNJ8pukE2I_oc/s1600/4.bmp')] w-5/10 m-5">
            </div>
        </section>
